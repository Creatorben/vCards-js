...
(function vCardFormatter() {
  ...
  function getFormattedPhoto(photoType, url, mediaType, base64) {
    ...
    if (majorVersion >= 4) {
      // Manuell ausgeklammert, wegen änderung an version 3 für iOS Kompatibilität
  ...
  module.exports = {
    ...
    getFormattedString: function (vCard) {
      ...
      // Manuell auf 3.0 festgelegt, damit Umlaute funktionieren. Restlicher Aufbau scheint zu funktionieren
