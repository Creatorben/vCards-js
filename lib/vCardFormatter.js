...
(function vCardFormatter() {
  ...
  module.exports = {
    ...
    getFormattedString: function (vCard) {
      ...
      if (vCard.url) {
        // Wenn url ein Objekt ist (ähnlich wie socialUrls)
        ...
        // Backwards compatibility: Array von Strings
        else if (Array.isArray(vCard.url)) {
          vCard.url.forEach((urlString) => {
            formattedVCardString +=
              'URL' + encodingPrefix + ':' + e(urlString) + nl();
          });
        }
        // Backwards compatibility: Einzelner String
