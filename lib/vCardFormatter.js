...
(function vCardFormatter() {
  ...
  function getFormattedAddress(encodingPrefix, address) {
    ...
    if (
      ...
      if (majorVersion >= 4) {
        var addressType = address.details.label ? address.details.label : address.type;
        formattedAddress =
          'ADR;TYPE="' +
          addressType +
          '":;;' +
