...
export interface VCard
{
	...
	lastName: string;
	/**
	 * Phones with custom Apple X-ABLabel grouping.
	 * Each entry: { number: string, label: string } or a plain string.
	 */
	labeledPhones: Array<LabeledPhone | string>;
	/**
	 * Emails with custom Apple X-ABLabel grouping.
	 * Each entry: { email: string, label: string } or a plain string.
	 */
	labeledEmails: Array<LabeledEmail | string>;
	/**
	 * Addresses with custom Apple X-ABLabel grouping.
	 */
	labeledAddresses: Array<LabeledAddress>;
	/**
	 ...
	 * Can be a string, array of strings, or an object { label: url } for X-ABLabel grouping.
	 */
	url: string | Array<string> | { [label: string]: string };
	/**
...
/**
 * Represents an address entry for X-ABLabel grouping.
 */
export interface LabeledAddress extends Address
{
	/** Custom Apple X-ABLabel label. */
	label: string;
}

/**
 * Represents a phone entry for X-ABLabel grouping.
 */
...
/**
 * Represents an email entry for X-ABLabel grouping.
 */
